...
import {
  AddFollowPrizeParams,
  AddFollowPrizeResponse,
  DeleteFollowPrizeParams,
  DeleteFollowPrizeResponse,
  EndFollowPrizeParams,
  EndFollowPrizeResponse,
  GetFollowPrizeDetailParams,
  GetFollowPrizeDetailResponse,
  GetFollowPrizeListParams,
  GetFollowPrizeListResponse,
  UpdateFollowPrizeParams,
...
export class FollowPrizeManager extends BaseManager {
   ...
   */
  async addFollowPrize(params: AddFollowPrizeParams): Promise<AddFollowPrizeResponse> {
    const response = await ShopeeFetch.fetch<AddFollowPrizeResponse>(
      this.config,
   ...
   */
  async deleteFollowPrize(params: DeleteFollowPrizeParams): Promise<DeleteFollowPrizeResponse> {
    const response = await ShopeeFetch.fetch<DeleteFollowPrizeResponse>(
      this.config,
   ...
   */
  async endFollowPrize(params: EndFollowPrizeParams): Promise<EndFollowPrizeResponse> {
    const response = await ShopeeFetch.fetch<EndFollowPrizeResponse>(
      this.config,
   ...
   * - follow_prize.campaign_none: The promotion id does not exist
   */
  async getFollowPrizeDetail(
    params: GetFollowPrizeDetailParams
  ): Promise<GetFollowPrizeDetailResponse> {
    const response = await ShopeeFetch.fetch<GetFollowPrizeDetailResponse>(
      this.config,
   ...
   */
  async getFollowPrizeList(params: GetFollowPrizeListParams): Promise<GetFollowPrizeListResponse> {
    const response = await ShopeeFetch.fetch<GetFollowPrizeListResponse>(
      this.config,
   ...
   */
  async updateFollowPrize(params: UpdateFollowPrizeParams): Promise<UpdateFollowPrizeResponse> {
    const response = await ShopeeFetch.fetch<UpdateFollowPrizeResponse>(
      this.config,
